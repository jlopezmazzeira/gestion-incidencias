...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <form action="/proyecto-usuario" method="POST">
            ...
            <div class="row">
                <div class="col-md-4">
                    <select name="project_id" id="select-project" class="form-control">
                ...
                <div class="col-md-4">
                    <select name="level_id" id="select-level" class="form-control">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/proyecto-usuario/{{ $project_user->id }}/eliminar" class="btn btn-danger btn-sm" title="Dar de baja">
